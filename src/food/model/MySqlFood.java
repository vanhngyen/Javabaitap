...
public class MySqlFood {
    Connection connection;
    private final String BASE_URL = "jdbc:mysql://localhost:3306/";
    private final String DATABASE_NAME = "food";
    ...
    private static MySqlFood instance;


    public static MySqlFood getInstance(){
        if(instance == null){
            instance = new MySqlFood();
        }
        return instance;
    }
